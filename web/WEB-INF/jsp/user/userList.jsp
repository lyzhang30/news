...
<div class="rightinfo">
    <div class="tools">
        <ul class="toolbar">
            <li class="click"><a href="${pageContext.request.contextPath}/toAddUser"><span><img src="images/t01.png" /></span>添加用户</a></li>
        </ul>
    </div>
    <form action="${pageContext.request.contextPath}/findUserList" id="userListForm"
          name="ff" method="post">
        <ul class="seachform">
